...
export default function StatisticsBooksPage() {
  const essentialBooks = statisticsBooks.filter(b => b.priority === 'essential')
  const recommendedBooks = statisticsBooks.filter(b => b.priority === 'recommended')
        ...
        <main className="flex-1">
          ...
          <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
              <p><strong>Essential Foundation:</strong> Searle's "Linear Models" is the definitive reference for understanding the mathematical theory underlying mixed models and BLUP.</p>
              <p><strong>Prerequisites:</strong> Strong background in matrix algebra and mathematical statistics recommended.</p>
              <p><strong>Connection to Animal Breeding:</strong> Linear models form the statistical foundation for genetic evaluation and breeding value prediction.</p>
            </div>
          </div>
        </main>
      </div>
